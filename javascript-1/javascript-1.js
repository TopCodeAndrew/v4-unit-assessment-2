...
*/
  ...
  let phone1 = new Phone("Motorola", "JX200", 10, "Black", true)
  
  let phone2 = new Phone("Google", "Lit", 10, "Black", true)
  
  let phone3 = new Phone("iPhone", "X", 10, "Black", true)
